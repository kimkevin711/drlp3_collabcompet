...
class Actor(nn.Module):
    ...
    def __init__(self, state_size, action_size, seed, fc1_units=136, fc2_units=56, fc3_units=None):
...
#     def __init__(self, state_size, action_size, seed, fcs1_units=216, fc2_units=156):
    def __init__(self, state_size, action_size, seed, fcs1_units=136, fc2_units = 56, fc3_units=None):
        """Initialize parameters and build model.
        Params
        ======
            state_size (int): Dimension of each state
...
#         self.fc3_bn = nn.BatchNorm1d(fc3_units)
    ...
    def forward(self, state, action):
        ...
        xs = self.fc_dp(F.relu(self.fcs1_bn(self.fcs1(state))))
